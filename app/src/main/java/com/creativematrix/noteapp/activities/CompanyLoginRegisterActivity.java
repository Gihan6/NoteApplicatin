...
public class CompanyLoginRegisterActivity extends AppCompatActivity implements RegisterCallbacks {
    public static final String TAG = CompanyLoginRegisterActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_login_register);


            mFragmentManager = getSupportFragmentManager();
            companyRegisterFragment = new CompanyRegisterFragment();
        ...
        //startService(new Intent(CompanyLoginRegisterActivity.this, FloatingService.class));



        SharedPreferences sharedPreferences = getSharedPreferences("company_file", MODE_PRIVATE);
        if (sharedPreferences != null) {
            String userName = sharedPreferences.getString("companyEmail", "NA");
