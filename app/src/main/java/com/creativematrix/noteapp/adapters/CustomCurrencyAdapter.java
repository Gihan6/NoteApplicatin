...
public class CustomCurrencyAdapter extends BaseAdapter {
    ...
    public CustomCurrencyAdapter(Context context, ArrayList<CurrencyList> items ) {
        this .currencyLists = items;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final String username = currencyLists.get(i).getCurrencyName();
