...
public class PlaybackFragment extends DialogFragment {
    ...
    public PlaybackFragment newInstance(String path) {
        PlaybackFragment f = new PlaybackFragment();
        Bundle b = new Bundle();
        b.putString(ARG_ITEM, path);
        f.setArguments(b);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPath = getArguments().getString(ARG_ITEM);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ColorFilter filter = new LightingColorFilter
                (getResources().getColor(R.color.color_blue_primary), getResources().getColor(R.color.color_blue_primary));
